                ...
                <Col md={3}>
                    <div className={styles.infoPlayer}>
                        <Avatar
                            ...
                            shape="square"
                            src={player.playlist.length > 0 && player.isPlayingMusic >= 0 ?
                                player.playlist[player.isPlayingMusic].avatar
                                :
                        ...
                        <div className={styles.infoPlayerNameAndAuthor}>
                            ...
                            <Typography className={styles.infoPlayerName} variant="subtitle1" component="h4">
                                {player.playlist.length > 0 && player.isPlayingMusic >= 0 ?
                                    player.playlist[player.isPlayingMusic].name
                                    :
                                    ''
                                }
                            </Typography>
                            ...
                            <small>
                                {player.playlist.length > 0 && player.isPlayingMusic >= 0 ?
                                    player.playlist[player.isPlayingMusic].author
                                    :
                                    ''
                                }
                            </small>
